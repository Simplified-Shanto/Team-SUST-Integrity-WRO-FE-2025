...
void loop() {
  ...
  if (currentWallDist > 2 * wallDistance && currentWallDist > oppositeWallDist) {
    // If the opposite wall is nearer, switch sides
    if (oppositeWallDist < 50) {
      wallSide = (wallSide == 0) ? 1 : 0;
    }
  ...
  if (debugPrint == 1) {
    ...
    display.print("L:"); display.print(leftDistance);
    display.print(" R:"); display.print(rightDistance);
    display.print(" F:"); display.println(frontDistance);
    display.print("Wall:"); display.print(wallSide == 0 ? "L" : "R");
    display.print(" D:"); display.println(wallDistance);
    display.print("PID:"); display.println(PIDangle);
    display.display();
  }
}
